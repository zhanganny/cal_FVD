...
def create_id3_embedding(videos):
  ...
  print("videos.name:", videos.name, "module_name", module_name)
  ...
  print("_is_in_graph(tensor_name)", _is_in_graph(tensor_name))
  # if not _is_in_graph(tensor_name):
    # i3d_model = hub.Module(module_spec, name=module_name)
  i3d_model = hub.KerasLayer(module_spec, name=module_name)
  a = i3d_model(videos)
  print("a??????", a)

  # gets the kinetics-i3d-400-logits layer
  # tensor_name = module_scope + "RGB/inception_i3d/Mean:0"
  tensor_name = module_name + "/StatefulPartitionedCall:0"
  # tensor_name = "fvd_kinetics-400_id3_module_sub_1_0/StatefulPartitionedCall:0"
